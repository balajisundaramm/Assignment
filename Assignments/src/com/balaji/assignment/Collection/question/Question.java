package com.balaji.assignment.Collection.question;
/**
 * 
 * @author spaneos
 *
...
public class Question {
	 private String question;
	    ...
	    public boolean equals(Object o) {
	        ...
	        if (!option1.equals(question1.option1)) return false;
	        if (!option2.equals(question1.option2)) return false;
	        if (!option3.equals(question1.option3)) return false;
	        if (!option4.equals(question1.option4)) return false;

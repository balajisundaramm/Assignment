    ...
    public void showResult(){
        ...
        /*listOfQuestions().forEach(Question-> {
                    while (flag) {
                        ...
                        switch (option) {
                            case 'A':
                                return (Question.getOption1().equals(Question.getAnswer())) ? ccount++ : wcount++;
                            flag = false;
                            break;
                            case 'B':
                                return (Question.getOption2().equals(Question.getAnswer())) ? ccount++ : wcount++;
                            flag = false;
                            break;
                            case 'C':
                                return (Question.getOption3().equals(Question.getAnswer())) ? ccount++ : wcount++;
                            flag = false;
                            break;
                            case 'D':
                                return (Question.getOption4().equals(Question.getAnswer())) ? ccount++ : wcount++;
                            flag = false;
                            break;
                            default:
                                System.out.println("Enter only A or B or C or D");
